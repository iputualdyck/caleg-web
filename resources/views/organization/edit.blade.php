...
@section('menu_title','Edit Organization')
@section('content')
     ...
     <div class="col-md-8 col-md-offset-2">
       <div class="panel panel-default">
         <div class="panel-body">
           <h4>Form Edit Organization</h4>
           <form action="{{ route('organization.update',$data->id) }}" method="post">
             @csrf @method('patch')
             <div class="form-group">
               <label for="">Career Organization</label>
               <input type="text" class="form-control" name="organization_description" autofocus
               placeholder="Example : Partai Pan" value="{{ $data->organization_description }}">
             </div>
